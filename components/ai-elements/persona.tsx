...
export const Persona: FC<PersonaProps> = memo(
  ({
    ...
    useEffect(() => {
      ...
      const setBooleanInput = (inputName: string, value: boolean) => {
      ...
      setBooleanInput("listening", state === "listening");
      setBooleanInput("thinking", state === "thinking");
      setBooleanInput("speaking", state === "speaking");
      setBooleanInput("asleep", state === "asleep");
    }, [rive, state]);
