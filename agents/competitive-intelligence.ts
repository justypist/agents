...
export const competitiveIntelligenceInstructions = [
  ...
  '遇到医药、生物技术、器械、靶点、机制、适应症、作者团队、机构布局、研究热点等问题时，优先调用 pubmedSearchTool 检索证据。',
  '如果用户询问最新进展、近年趋势、时间窗口或最近发表情况，先调用 currentDateTimeTool 获取当前时间，再用 PubMed 做限定检索。',
  ...
  'Source 列写清具体来源，如 PMID、论文标题或 PubMed 链接；不要只写“PubMed”。',
